...
class recoveryController extends Controller {
	...
	public function index($page = 1) {
		...
		$this->document->setActiveItem('recovery');
		...
		$paginationLib->url = $this->config->url . '/account/recovery/index/{page}';
		
		$pagination = $paginationLib->render();
		
		$this->data['tickets'] = $tickets;
		$this->data['pagination'] = $pagination;
		$this->getChild(array('common/recoveryheader', 'common/loginfooter'));
		return $this->load->view('account/recovery', $this->data);
	}
