...
<head>
    <meta charset="utf-8"/>
    <title>24HoursHost - Завершение регистрации</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="24HoursHost - Завершение регистрации"/>
...
<header id="topnav" class="defaultscroll sticky">
    <div class="container">
        ...
        <div class="buy-button">
            <a href="https://24hours.host/" class="text-dark h6 mr-3 login-dark" data-toggle="modal"
               data-target="#LoginForm">Главная</a>
...
<section class="bg-home d-flex align-items-center"
         style="background: url('/ru/404/email.png') top center; height: auto;" id="home">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 mt-0 mt-md-5 pt-0 pt-md-5">
                <div class="title-heading text-center margin-top-100">
                    <?php if (@$user): ?>
                        <h4 class="heading mb-3">Завершение регистрации.</h4>
                        <p class="text-muted para-desc mx-auto mb-0">Ваш Аккаунт подтверждён! Авторизуйтесь для входа в
                            панель управления.</p>
                    <?php else: ?>
                        <h4 class="heading mb-3">Упс... Что-то пошло не так.</h4>
                        <p class="text-muted para-desc mx-auto mb-0">Повторите вашу попытку снова.</p>
                    <?php endif ?>
