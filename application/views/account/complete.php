...
<html lang="ru">
    ...
    <head>
        <meta charset="utf-8" />
        <title>24HoursHost - Регистрация</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="24HoursHost - Регистрация" />
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 mt-0 mt-md-5 pt-0 pt-md-5">
                        <div class="title-heading text-center margin-top-100">
                            ...
                            <p class="text-muted para-desc mx-auto mb-0">Проверьте вашу почту, на нее должно прийти сообщение с дальнейшими инструкциями.</p>
